...
int main() {
    ...
    HoughLinesP(detectimgsrcP, linesP, 1, CV_PI / 360, 20 ,10, 7); 
    ...
    HoughLinesP(detectimgsrcP, linesPagain, 1, CV_PI / 180, 20,10, 7); 
...
//     //imshow("Line Detection P", detectimgsrcP);
    ...
    HoughLinesP(detectimgsrcP, linesPagainagain, 1, CV_PI / 180, 20 ,10, 7); 
   ...
   // imwrite ("/home/learn/Documents/cv/practice/projects/HoughP/hpResult1_180_20_10_5.png", detectimgsrcP);	
    ...
    //dilate(detectimgsrcP,detectimgsrcP,kernel,Point(-1,-1),1,0,MORPH_RECT);
    ...
    // //erode(detectimgsrcP,detectimgsrcPeroded,kernel,Point(-1,-1),2,0,MORPH_ERODE);
    // morphologyEx(detectimgsrcP,detectimgsrcPeroded,MORPH_ERODE,kernel,Point(-1,-1),1,0,morphologyDefaultBorderValue());

    imshow("Line Detection P after morphological ops", detectimgsrcP);
    imwrite ("/home/learn/Documents/cv/practice/projects/HoughP/hpResult1_360_180_20_10_7_otsu.png", detectimgsrcP);
